...
Handles intents: create_influencer, refine_brand_kit, plan_week, generate_drafts, adapt_from_master.
...
def _handle_unknown(db: Session, session: AgentSession, req: AgentRunRequest) -> AgentRunResponse:
    ...
    return AgentRunResponse(
        ...
        next_steps=[
            "Intents válidos: create_influencer, refine_brand_kit, plan_week, generate_drafts, adapt_from_master"
        ],
    )
